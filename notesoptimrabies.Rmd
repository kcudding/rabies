...
```
Total cost of the campaign is then `r sum(campcost)`. This calculation gives total staff needed to deliver `r sum(meths)` vaccinations, as `r round(tstaff)` for 30 days.
